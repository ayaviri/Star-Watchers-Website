...
const getGeniusData = async(searchQuery) => {
    const name = 'Genius';
...
const getTwitterData = async(searchQuery) => {
    const name = 'Twitter';
...
const getTumblrData = async(searchQuery) => {
    const name = 'Tumblr';
...
const getRedditData = async(searchQuery) => {
    let formatted = {
        "name": "Reddit",
...
const getYoutubeData = async(searchQuery) => {
    let formatted = {
        "name": "YouTube",
...
export const getGoogleTrends = async(searchQuery) => {
...
// console.log(await getData('fnaf'));
// console.log(await getTrendingData());
// await getGoogleTrends('fnaf');